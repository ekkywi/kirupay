...
const ERROR_GROUPS = [
  {
    ...
    items: [
      ...
      { id: "error-checkout_duplicate_order_id", code: "CHECKOUT_DUPLICATE_ORDER_ID", status: 409, action: "Use unique orderId per business." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "error-auth_merchant_not_found", code: "AUTH_MERCHANT_NOT_FOUND", status: 404, action: "Confirm businessId mapping and account existence." },
