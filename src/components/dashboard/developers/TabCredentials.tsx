  ...
  return (
    <div className="dashboard-card p-5">
      ...
      <div className="flex flex-col gap-3 lg:flex-row">
        <div className="flex min-w-0 flex-1 items-center gap-3 dashboard-muted-panel px-3 py-3 dark:border-white/10 dark:bg-white/[0.03]">
...
function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[50] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="dashboard-card w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200 dark:border-white/10 dark:bg-white/[0.045]">
...
export function TabCredentials({ merchant, canManage = true }: { merchant: DeveloperMerchant; canManage?: boolean }) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      {toast && (
        <div className={`fixed right-6 top-6 z-[100] flex items-center gap-3 rounded-2xl border bg-white px-4 py-3 shadow-2xl animate-in slide-in-from-top-5 fade-in duration-300 dark:bg-white/[0.045] ${toast.type === "success" ? "border-emerald-200 dark:border-emerald-500/20" : "border-red-200 dark:border-red-500/20"}`}>
      ...
      <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-5 dark:border-emerald-500/20 dark:bg-emerald-500/10">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-emerald-950 dark:text-emerald-100">Production security area</h4>
