  ...
  return (
    <div className="docs-article-grid">
      <article className="relative overflow-hidden rounded-[2rem] border border-white/75 bg-white/76 p-5 shadow-xl shadow-slate-900/6 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.045] dark:shadow-black/20 sm:p-6 lg:p-8">
        <div className="pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-emerald-300/20 blur-3xl dark:bg-emerald-400/10" />
        ...
        <div className="relative border-b border-slate-200/70 pb-7 dark:border-white/10">
          <span className="inline-flex items-center gap-2 rounded-full border border-emerald-200/80 bg-emerald-50/80 px-3 py-1.5 text-[0.68rem] font-black uppercase tracking-[0.18em] text-emerald-800 dark:border-emerald-300/15 dark:bg-emerald-300/10 dark:text-emerald-200">
        ...
        <div
          className="
            ...
            [&_h2]:border-l-4 [&_h2]:border-emerald-400 [&_h2]:pl-3
            ...
            [&_li]:leading-7 [&_li::marker]:text-emerald-500
            ...
            [&_code]:rounded-md [&_code]:bg-emerald-50 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-[13px] [&_code]:font-semibold [&_code]:text-emerald-800 [&_code]:dark:bg-emerald-300/10 [&_code]:dark:text-emerald-200
            ...
            [&_th]:bg-emerald-50/80 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:text-xs [&_th]:font-black [&_th]:uppercase [&_th]:tracking-[0.12em] [&_th]:text-emerald-800 [&_th]:dark:bg-emerald-300/10 [&_th]:dark:text-emerald-200
            ...
            [&_a]:font-bold [&_a]:text-emerald-700 [&_a]:underline [&_a]:decoration-emerald-400/60 [&_a]:underline-offset-4 [&_a]:dark:text-emerald-300
          "
        >
          {children}
        </div>
        ...
        <div className="relative mt-10 grid gap-3 sm:grid-cols-2">
          {prev ? (
            <Link href={`/docs/${prev.slug}`} className="group rounded-[1.25rem] border border-slate-200/80 bg-white/68 px-4 py-3 transition-all hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-white dark:border-white/10 dark:bg-white/[0.035] dark:hover:border-emerald-300/30 dark:hover:bg-white/[0.07]">
          ...
          {next ? (
            <Link href={`/docs/${next.slug}`} className="group rounded-[1.25rem] border border-slate-200/80 bg-white/68 px-4 py-3 text-right transition-all hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-white dark:border-white/10 dark:bg-white/[0.035] dark:hover:border-emerald-300/30 dark:hover:bg-white/[0.07]">
      ...
      <aside className="docs-toc-card sticky top-28 hidden h-fit p-4 2xl:block">
        <p className="text-[11px] font-black uppercase tracking-[0.18em] text-emerald-700 dark:text-emerald-300">On this page</p>
        <div className="mt-3 space-y-1.5">
          {toc.map((item) => (
            <a
              key={item.id}
              href={`#${item.id}`}
              className="block rounded-xl border border-transparent px-3 py-2 text-xs leading-snug text-slate-600 transition-colors hover:border-emerald-200/80 hover:bg-emerald-50/70 hover:text-emerald-800 dark:text-slate-300 dark:hover:border-emerald-300/15 dark:hover:bg-emerald-300/10 dark:hover:text-emerald-200 whitespace-normal break-words"
            >
              {item.label}
            </a>
          ))}
